...
.PHONY: generate
generate:
	go generate -run="plugindata/main.go$$" ./plugins/inputs/...
	go generate -run="plugindata/main.go$$" ./plugins/outputs/...
	go generate -run="plugindata/main.go$$" ./plugins/processors/...
	go generate -run="plugindata/main.go$$" ./plugins/aggregators/...

.PHONY: cleanGenerate
cleanGenerate:
	go generate -run="plugindata/main.go --clean" ./plugins/inputs/...
	go generate -run="plugindata/main.go --clean" ./plugins/outputs/...
